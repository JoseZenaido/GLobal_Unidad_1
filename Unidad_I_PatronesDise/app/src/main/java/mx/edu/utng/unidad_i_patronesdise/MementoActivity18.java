...
public class MementoActivity18 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        estrella = new Estrella1();
        lienzo = new Lienzo7(this, estrella);
        ...
        btnRehacer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                estrella.restaurarMemento(careTaker.getMemento(actual));
                lienzo.setEstrella(estrella);
                lienzo.invalidate();
            }
        });
    ...
    public void setMemento(int color) {
        estrella.setColor(color);
        lienzo.setEstrella(estrella);
        lienzo.invalidate();
        careTaker.addMemento(estrella.guardarMemento());
